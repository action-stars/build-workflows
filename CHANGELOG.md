...
- Update _actions/checkout_ from `6.0.1` to `6.0.2`. ([#60](https://github.com/action-stars/build-workflows/pull/60)) _@dependabot_
- Update _github/codeql-action_ from `4.31.10` to `4.32.1`. ([#60](https://github.com/action-stars/build-workflows/pull/60)) _@dependabot_
- Update _docker/login-action_ from `3.6.0` to `3.7.0`. ([#60](https://github.com/action-stars/build-workflows/pull/60)) _@dependabot_
- Update _actions/attest-build-provenance_ from `3.1.0` to `3.2.0`. ([#60](https://github.com/action-stars/build-workflows/pull/60)) _@dependabot_
