...
- Update _actions/checkout_ from `5.0.0` to `5.0.1`. ([#49](https://github.com/action-stars/build-workflows/pull/49)) _@dependabot_
- Update _github/codeql-action_ from `4.31.2` to `4.31.3`. ([#49](https://github.com/action-stars/build-workflows/pull/49)) _@dependabot_
